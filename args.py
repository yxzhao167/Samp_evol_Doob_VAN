...
group.add_argument('--dtype', type=str, default='float64', choices=['float32', 'float64'], help='dtype')
...
group.add_argument('--load_Doob', type=int, default=0, help='load the VAN with Doob')  
group.add_argument(
...
group.add_argument(
    '--pre_train_step', type=int, default=3500, help='number of steps to calculate SCGF'
)
group.add_argument(
    '--pre_train_step_next', type=int, default=500, help='number of steps to calculate the next SCGF'
)
group.add_argument(
    '--lambda_tilt_prev', type=int, default=0, help='the lambda of the previous group'
)
group.add_argument('--device', type=str, default='cuda', help='Device to use (cpu or cuda)')  
